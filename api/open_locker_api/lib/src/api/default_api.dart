...
import 'package:open_locker_api/src/api_util.dart';
import 'package:open_locker_api/src/model/item.dart';
...
class DefaultApi {
  ...
  Future<Response<BuiltList<Item>>> itemsGet({
    String? state,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Item>> itemsIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/items/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Item>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Item>>> userIdLentItemsGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/user/{id}/lent-items'.replaceAll(
        '{' r'id' '}',
